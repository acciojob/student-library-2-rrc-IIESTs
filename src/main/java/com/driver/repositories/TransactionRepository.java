...
public interface TransactionRepository extends JpaRepository<Transaction, Integer> {
    ...
    @Query("select t from Transaction t where t.card.id=:cardId and t.book.id=:bookId and t.isIssueOperation=:isIssue and t.transactionStatus=:status order by t.transactionDate")
